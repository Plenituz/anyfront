...
<Accordion single>
    ...
    <div class="content m-b-sm">
        <p>Sends a password reset email to an admin.</p>
    </div>
    ...
    <div class="api-route alert alert-success">
        ...
        <div class="content">/api/admins/request-password-reset</div>
    </div>
    ...
    <table class="table-compact table-border">
        ...
        <tbody>
            <tr>
                ...
                <td>The email address to send the password reset request (if existing).</td>
            </tr>
        </tbody>
    </table>
