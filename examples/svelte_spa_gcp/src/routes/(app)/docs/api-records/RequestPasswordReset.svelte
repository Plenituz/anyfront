...
<Accordion single>
    ...
    <div class="content m-b-sm">
        <p>Sends a password reset email to a specified auth record email.</p>
    </div>
    ...
    <div class="api-route alert alert-success">
        ...
        <div class="content">/api/collections/<code>collectionIdOrName</code>/request-password-reset</div>
    </div>
    ...
    <table class="table-compact table-border">
        ...
        <tbody>
            <tr>
                ...
                <td>The email address to send the password reset request (if registered).</td>
            </tr>
        </tbody>
    </table>
